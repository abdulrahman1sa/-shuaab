      ...
      <section className="max-w-7xl mx-auto text-center mb-20">
        <div className="relative inline-block mb-8">
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-4 -rotate-[1deg]">
            دليـل <span className="bg-[#FFD400] px-4 doodle-border-sm rotate-[2deg] inline-block flex items-center gap-3">
              <img src="/duck-logo.svg" className="w-16 h-16 md:w-24 md:h-24 inline-block -mt-2 object-contain" alt="Duck Logo" />
              الشُعب
            </span>
          </h1>
        </div>
